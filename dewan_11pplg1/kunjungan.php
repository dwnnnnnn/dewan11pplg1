...
<div class="container">
    ...
    <div class="row">
        <div class="col">
            <a href="tambahkunjungan.php" class="btn btn-primary btn-sm d-flex justify-content-center">Tambah Data Kunjungan</a>
        </div>
    </div>
    ...
    <div class="row mt-3">
        <div class="col">
            <table class="table table-striped table-hover table-sm">
                ...
                include 'config.php';
                $no = 1;
                $hasil = $konek->query("SELECT * FROM kunjungan");
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form method="post" action="deletekunjungan.php" style="display:inline;" onsubmit="return confirmDeletion(this);">
                            <input type="hidden" name="id" value="<?= $row['idKunjungan']; ?>">
